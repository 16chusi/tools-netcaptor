...
export const NODE_CONFIGS: NodeConfig[] = [
  ...
  { type: 'jsonl_reader', label: 'JSONL读取器', icon: '📄', color: '#b37feb', description: '读取JSONL文件并循环' },
  { type: 'intercept_request', label: '拦截请求', icon: '🚫', color: '#ff9c6e', description: '拦截和修改HTTP请求' }
]
